...
const OrderPizza = () => {
  ...
  return (
    <div className="p-5 h-[85vh] bg-gradient-to-r from-dark-blue via-dark-blue to-dark-blue-1 flex flex-col justify-center items-center space-y-5">
      <h2 className=" text-4xl md:text-7xl lg:text-6xl font-bold text-center text-white">
        Revisa tu pedido
      </h2>
      <div className=" w-full lg:w-[60%] relative h-[60vh] bg-white-glass border-2 border-blue rounded-lg  ">
