...
const InfoItem = ({icon , text}) => {
    return (
        <article className=' w-full md:w-80 h-60  text-gray-500 flex flex-col items-center justify-between md:justify-center border-2 border-gray-500  shadow-md lg:border-gray-400 lg:text-gray-400 lg:hover:text-gray-500 lg:hover:border-gray-500 shadow-gray-200 p-10 rounded-lg hover:shadow-xl hover:shadow-gray-500  transition-all ' >
