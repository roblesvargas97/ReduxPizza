...
const ShoppingCartButton = () => {
  ...
  return (
    <button
      ...
      } relative z-0 group h-14 w-14 flex justify-center py-2 items-center text-2xl font-bold px-2 border-2 hover:border-blue rounded-lg bg-white-glass  backdrop-blur-lg text-white transition-all`}
    >
      <div
        className={` ${
          ShowCart
